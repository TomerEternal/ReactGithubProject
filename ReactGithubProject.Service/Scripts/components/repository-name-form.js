...
var RepositoryNameForm = /** @class */ (function (_super) {
    ...
    function RepositoryNameForm(props) {
        ...
        _this.handleSubmit = function (event) {
            ...
            _this.context.search(_this.state.repositoryName);
        };
    ...
    RepositoryNameForm.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "jumbotron position-relative" },
                React.createElement("video", { className: "card-img-overlay p-0 h-100 w-100", style: { objectFit: 'cover' }, id: "video-background", muted: true, autoPlay: true, loop: true },
    ...
    RepositoryNameForm.contextType = repositories_context_1.RepositioresContext;
